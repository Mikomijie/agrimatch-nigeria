    ...
    >
      ...
      <div className="p-4 sm:p-6">
        ...
        <p className="text-sm text-gray-700 mb-4">
          Order from <span className="font-semibold">{order.listings?.profiles?.full_name}</span>. Pickup and deliver to buyer.
        </p>
...
function TransporterLoadBoard() {
  ...
  async function fetchOrders() {
    ...
    let query = supabase
      .from('orders')
      .select('*, listings(crop_type, location, image_url, profiles(full_name))')
