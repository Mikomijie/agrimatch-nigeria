  ...
  return (
    <div className="min-h-screen bg-[var(--color-background-warm)]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-8 sm:py-12 pb-24 md:pb-12">
        ...
        {/* VERIFICATION STATUS CARD (VFR-002) */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        {/* VERIFICATION APPLICATION MODAL (VFR-002) */}
        {showVerificationForm && (
          <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
            ...
            >
              <h2 className="text-2xl font-bold text-[var(--color-charcoal)] mb-1">Apply for Verification</h2>
              <p className="text-sm text-[var(--color-charcoal)]/60 mb-6">Provide your farm details and a photo as evidence. AgriMatch will review and respond.</p>
